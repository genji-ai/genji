// Reproduced with modifications from https://github.com/philc/vimium/blob/master/lib/dom_utils.js
...
export const DomUtils = {
  ...
  getClientRectsForAreas(imgClientRect, areaEls) {
    ...
    for (const areaEl of areaEls) {
      ...
      // values.
      const isValid =
        rect && !isNaN(rect.top) && !isNaN(rect.left) && !isNaN(rect.width) && !isNaN(rect.height)
  ...
  simulateClick(element, modifiers) {
    ...
    for (const event of eventSequence) {
      const defaultActionShouldTrigger = this.simulateMouseEvent(event, element, modifiers)
